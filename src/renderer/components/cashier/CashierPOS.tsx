...
const WalkInRegistrationFeeModal: React.FC<{
  ...
  const classFilteredItems = (matchedBundle?.items || []).filter(
    (item: any) => {
        ...
        <div className="flex flex-1 min-w-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="bg-white border-b px-5 py-4 shrink-0">
              ...
              <div ref={studentRef} className="flex gap-2 relative">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    onFocus={() =>
                      studentSuggestions.length > 0 && setShowStudentDrop(true)
                    }
                    ...
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white border rounded-xl shadow-lg z-30">
                      ...
                      {studentSuggTotalPages > 1 && (
                        <div className="flex items-center justify-center gap-2 px-4 py-2 border-t bg-gray-50">
                          <button
                            onClick={() =>
                              setStudentSuggPage((p) => Math.max(1, p - 1))
                            }
                        ...
                        {walkInEditMode ? (
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              onChange={(e) =>
                                setWalkInEditName(e.target.value)
                              }
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setWalkInEditClass(e.target.value)
                              }
                        ...
                        <button
                          ...
                          onClick={() =>
                            setHistoryDrawerTarget({
                              ...
                              class:
                                walkInApplicant.proposed_class || "Applicant",
                              isApplicant: true,
                            })
                          }
                  ...
                  {!walkInEditMode && (
                    <>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleWalkInBundleAction("registration")
                          }
                          className="flex flex-col items-center gap-1 py-2.5 px-2 bg-white border border-warning-200 rounded-lg hover:bg-warning-100 text-warning-800 transition-all"
                        >
                          <span className="text-base font-extrabold">₦₦</span>
              ...
              {selectedStudent &&
                quickAddedStudentIds.has(selectedStudent.student_id) && (
                ...
                <div className="mt-3 flex items-center justify-between bg-blue-50 border border-blue-200 rounded-xl px-4 py-2.5">
                  <div className="min-w-0">
                    ...
                    <span className="text-xs text-blue-600 ml-2 font-medium">
                      ({selectedStudent.student_class} &bull;{" "}
                      {selectedStudent.student_id})
                    </span>
                  </div>
                  <button
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <button
                                ...
                                className={`flex items-center justify-center gap-2 py-3 rounded-xl font-semibold border-2 transition-all ${feesPayMode === "Cash" ? "bg-success-600 border-success-600 text-white" : "bg-white border-gray-200 text-gray-600 hover:border-success-400"}`}
                              >
                                <Banknote className="w-4 h-4" /> CASH
                              </button>
                              <button
                                onClick={() => setFeesPayMode("POS_Transfer")}
                                className={`flex items-center justify-center gap-2 py-3 rounded-xl font-semibold border-2 transition-all ${feesPayMode === "POS_Transfer" ? "bg-primary-600 border-primary-600 text-white" : "bg-white border-gray-200 text-gray-600 hover:border-primary-400"}`}
                              >
                                <CreditCard className="w-4 h-4" /> POS
                              </button>
                            </div>
            ...
            {selectedStudent && saleMode === "bundles" && (
              <div className="flex-1 overflow-auto p-4">
                <div className="max-w-2xl mx-auto space-y-4 mt-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Select a bundle for <strong>{selectedStudent.name}</strong>
                  </p>
                  ...
                  {bundles.filter((b) => b.is_active).length === 0 ? (
                    <div className="bg-gray-50 border border-dashed border-gray-200 rounded-xl p-8 text-center text-gray-400">
                      ...
                      <p className="text-sm mt-1">
                        Ask admin to create bundle packages
                      </p>
                    </div>
                  ) : (
                        ...
                        .map((bundle) => (
                          ...
                          >
                            <div className="flex items-start justify-between">
                              <div>
                                <span
                                  className={`inline-block text-[10px] font-bold px-2 py-0.5 rounded mb-2 ${bundle.bundle_type === "acceptance" ? "bg-primary-100 text-primary-700" : "bg-success-100 text-success-700"}`}
                                >
                                  {bundle.bundle_type === "acceptance"
                                    ? "Acceptance Fee"
                                    : "Registration"}
            ...
            {!selectedStudent && (
              <div className="flex-1 flex flex-col items-center justify-center text-gray-300 p-8">
                ...
                <p className="text-sm">
                  Select class and type the student's name
                </p>
              </div>
            )}
          </div>
                  ...
                  {cart.map((item) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          setCart((p) =>
                            p.filter((i) => i.item_id !== item.item_id),
                          )
                        }
