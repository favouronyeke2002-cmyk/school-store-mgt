...
import {
  LayoutDashboard, Users, Package, FileText, Clock, Settings, Upload, LogOut, ChevronRight, Store
} from 'lucide-react';
...
const navItems = [
  ...
  { id: 'users', label: 'Staff', icon: Settings },
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg mb-0.5 text-sm font-medium transition-all ${active ? 'bg-primary-50 text-primary-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}
              >
